...
const mission = [
  {
    icon: Heart,
    title: 'Наша миссия',
    description: 'Мы помогаем детям по всей России получить доступ к необходимому медицинскому лечению, когда семья не может справиться самостоятельно.',
    color: 'text-rose-500',
    bg: 'bg-rose-50',
  },
  {
...
const values = [
  { icon: Users, title: 'Команда профессионалов', desc: '15 лет опыта в благотворительности' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 text-lg max-w-2xl mx-auto">
            За годы работы мы помогли сотням детей и заслужили доверие тысяч жертвователей по всей стране.
          </p>
        </div>
